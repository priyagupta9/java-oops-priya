public class BookAdvanced {
    String name;
    AuthorAdvanced authors[];
    double price;
    int qty = 0;

    BookAdvanced(String name, AuthorAdvanced authors[], double price){
        this.name = name;
        this.authors = authors;
        this.price = price;
    }
    BookAdvanced(String name, AuthorAdvanced authors[], double price, int qty){
        this.name = name;
        this.authors = authors;
        this.price = price;
        this.qty = qty;
